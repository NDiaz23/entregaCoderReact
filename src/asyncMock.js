...
const productos = [
    ...
    {id: '10',
    nombre: 'NIKE PHANTOM GX ACADEMY - 600',
    descripcion:'El calzado Academy te brinda el toque de precisión que necesitas para que tus instintos de juego más internos deslumbren. Con NikeSkin, una zona de contacto de malla para mejorar la precisión y una placa de agilidad diseñada para girar y correr contigo, está listo para encender tu espíritu creativo y espontáneo.',
    precio: 6490,
    categoria: 'shoes',
    stock: 3,
    imagen: 'https://f.fcdn.app/imgs/21e086/www.globalsports.com.uy/gls/a8c5/webp/catalogo/NKDD9473-600-3/460x460/nike-phantom-gx-academy-600.jpg'
    }
]
